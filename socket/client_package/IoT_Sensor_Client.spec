...
a = Analysis(
    ...
    hiddenimports=['node_module', 'node_module.ecdhe_crypto', 'node_module.generate_packet', 'node_module.geohash_encode', 'cryptography.hazmat.primitives.asymmetric.x25519', 'cryptography.hazmat.primitives.asymmetric.ed25519', 'cryptography.hazmat.primitives.ciphers.aead', 'cryptography.hazmat.primitives.serialization', 'cryptography.hazmat.primitives.hashes', 'cryptography.hazmat.primitives.kdf.hkdf', 'Crypto.PublicKey.RSA', 'Crypto.Cipher.PKCS1_OAEP'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
